...
import { Permission, PermissionUpdateRequest } from '@app/shared/models';
...
export class PermissionsComponent implements OnInit, OnDestroy {
  ...
  fillPermissions(roleId: any) {
    this.blockedPanel = true;
    this.subscription.add(this.roleService.getRolePermissions(roleId).subscribe((response: Permission[]) => {
